      ...
      <div className="flex justify-center">
        <div
          style={{
            ...
            maxWidth: 800,
            height: 400,
            overflow: "visible", // evita il taglio delle label
          }}
        >
            ...
            <PieChart>
              <Pie
                ...
                label={({
                  ...
                  const radius = outerRadius + 20; // distanza dal bordo della torta
                  const x =
                  ...
                  return (
                    <text
                      ...
                      fontSize={16}
                    >
                      {`${payload.instanceType}: ${(percent * 100).toFixed(
                        1
                      )}% (€${payload.avg_item_cost.toFixed(0)})`}
                    </text>
                  );
                }}
              >
